...
impl internal fun <T> runBlockingImpl(
    ...
    val eventLoop = if (context[ContinuationInterceptor] == null) EventLoopImpl() else null
...
private class BlockingCoroutine<T>(
    ...
    fun joinBlocking(): T {
        ...
        while (true) {
            ...
            // TODO: Any way to sleep on JS? This code really should never fire in a well written application...
